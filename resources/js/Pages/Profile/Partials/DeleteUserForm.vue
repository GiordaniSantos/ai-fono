    ...
    <section class="space-y-6">
        <header>
            ...
            <p class="mt-1 text-sm text-gray-600">
                Assim que sua conta for excluída, todos os seus recursos e dados serão
                permanentemente apagados. Antes de excluir sua conta, por favor,
                baixe quaisquer dados ou informações que você deseje manter.
            </p>
        </header>
